...
E_D("DROP TABLE IF EXISTS `lonking_enewspostserver`;");
E_C("CREATE TABLE `lonking_enewspostserver` (
...
E_D("replace into `lonking_enewspostserver` values('1','附件服务器','','1','','','','','','0','0','0','0','0');");
