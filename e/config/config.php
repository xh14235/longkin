...
$ecms_config['db']['dbname']='lonking';	//数据库名
$ecms_config['db']['setchar']='utf8';	//设置默认编码
$ecms_config['db']['dbchar']='utf8';	//数据库默认编码
$ecms_config['db']['dbtbpre']='lonking_';	//数据表前缀
...
$ecms_config['esafe']['ecookiernd']='Mf8YULjx6EelcvMjmc2u4zlNr4gMqX';	//后台登录COOKIE认证码(填写10~50个任意字符，最好多种字符组合)
...
$ecms_config['cks']['ckvarpre']='rhytj';		//前台cookie变量前缀
$ecms_config['cks']['ckadminvarpre']='mbqwh';		//后台cookie变量前缀
$ecms_config['cks']['ckrnd']='spiv564LjKnIwlDg32206VK5IbyDhe';	//COOKIE验证随机码(填写10~50个任意字符，最好多种字符组合)
$ecms_config['cks']['ckrndtwo']='ike2eHKR4rQO5MtFiH9OjfJKvd2YE1';	//COOKIE验证随机码2(填写10~50个任意字符，最好多种字符组合)
...
//------------e_public
$public_r=array('sitename'=>'上海琅琨仪器仪表有限公司',
'newsurl'=>'/',
'filetype'=>'|.gif|.png|.jpg|.swf|.rar|.zip|.mp3|.wmv|.txt|.doc|',
'filesize'=>2048,
'relistnum'=>8,
'renewsnum'=>100,
'min_keyboard'=>2,
...
'keytog'=>2,
'keytime'=>30,
'keyrnd'=>'hUDTdtAQqw8ml23Z71AK1kQvzj8CPH',
...
'fbkey_ok'=>0,
'newaddinfotime'=>0,
'classnavs'=>'<a href=\"/about/\">关于琅琨</a>&nbsp;|&nbsp;<a href=\"/gongchenganli/\">工程案例</a>&nbsp;|&nbsp;<a href=\"/chanpinzhongxin/\">产品中心</a>&nbsp;|&nbsp;<a href=\"/xinwenzhongxin/\">新闻中心</a>',
'adminstyle'=>',1,2,',
'docnewsnum'=>300,
'openschall'=>0,
'schallfield'=>1,
...
'intb'=>0,
'mid'=>2);
$etable_r['project']=Array('deftb'=>'1',
'yhid'=>0,
'intb'=>0,
'mid'=>3);
...
'datatbs'=>',1,',
'deftb'=>'1',
'enter'=>',title,special.field,titlepic,newstime,detail,tec,typical,saled,share,download,',
'qenter'=>',title,special.field,titlepic,newstime,',
'listtempf'=>',title,titlepic,newstime,',
'tempf'=>',title,titlepic,newstime,detail,tec,typical,saled,share,download,',
'mustqenterf'=>',title,titlepic,newstime,detail,',
'listandf'=>'',
'setandf'=>0,
'searchvar'=>',title,',
'cj'=>',title,titlepic,newstime,',
'canaddf'=>',title,titlepic,newstime,detail,tec,typical,saled,share,download,',
'caneditf'=>',title,titlepic,newstime,detail,tec,typical,saled,share,download,',
'tbmainf'=>',title,titlepic,newstime,',
'tbdataf'=>',share,download,typical,saled,tec,detail,',
'tobrf'=>',',
'dohtmlf'=>',share,download,typical,saled,tec,detail,',
'checkboxf'=>',',
'savetxtf'=>'',
'editorf'=>',share,typical,saled,tec,detail,',
'ubbeditorf'=>',',
'pagef'=>'',
'smalltextf'=>',',
'filef'=>',download,',
...
'datatbs'=>',1,',
'deftb'=>'1',
'enter'=>',title,special.field,titlepic,newstime,intro,detail,',
'qenter'=>',title,special.field,titlepic,newstime,intro,detail,',
'listtempf'=>',title,titlepic,newstime,intro,',
'tempf'=>',title,titlepic,newstime,intro,detail,',
'mustqenterf'=>',title,titlepic,newstime,intro,detail,',
'listandf'=>'',
'setandf'=>0,
'searchvar'=>',title,',
'cj'=>',title,titlepic,newstime,',
'canaddf'=>',title,titlepic,newstime,intro,detail,',
'caneditf'=>',title,titlepic,newstime,intro,detail,',
'tbmainf'=>',title,titlepic,newstime,intro,',
'tbdataf'=>',detail,',
'tobrf'=>',',
'dohtmlf'=>',detail,intro,',
'checkboxf'=>',',
'savetxtf'=>'',
'editorf'=>',detail,',
'ubbeditorf'=>',',
...
'listtempf'=>',title,titlepic,newstime,intro,',
'tempf'=>',title,titlepic,newstime,intro,detail,',
'mustqenterf'=>',title,newstime,intro,detail,',
'listandf'=>'',
'setandf'=>0,
'searchvar'=>',title,',
'cj'=>',title,titlepic,newstime,',
...
'datatbs'=>',1,',
'deftb'=>'1',
'enter'=>',title,special.field,titlepic,newstime,detail,',
'qenter'=>',title,special.field,titlepic,newstime,detail,',
'listtempf'=>',title,titlepic,newstime,',
'tempf'=>',title,titlepic,newstime,detail,',
'mustqenterf'=>',title,titlepic,newstime,detail,',
'listandf'=>'',
'setandf'=>0,
'searchvar'=>',title,',
'cj'=>',title,titlepic,newstime,',
'canaddf'=>',title,titlepic,newstime,detail,',
'caneditf'=>',title,titlepic,newstime,detail,',
'tbmainf'=>',title,titlepic,newstime,',
'tbdataf'=>',detail,',
'tobrf'=>',',
'dohtmlf'=>',detail,',
