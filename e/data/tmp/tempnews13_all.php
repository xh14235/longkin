...
?>
  ...
  <div class="crumb">
    <div class="container">
      <div class="crumb-box">
          您现在的位置：<a href="/">首页</a>&nbsp;&gt;&nbsp;<a href="/about/intro.html">关于琅琨</a>
      </div>
    </div>
  </div>
  <!-- 内容 -->
  <div class="product">
    <div class="container">
      <div class="main clear">
        <div class="main-left">
          <div class="main-title"><?=$class_r[$ecms_gr[classid]][classname]?></div>
          <ul class="list-left">
  <?php
$bqno=0;
$ecms_bq_sql=sys_ReturnEcmsLoopBq(17,10,0,0,'','newstime ASC');
if($ecms_bq_sql){
while($bqr=$empire->fetch($ecms_bq_sql)){
$bqsr=sys_ReturnEcmsLoopStext($bqr);
$bqno++;
