...
E_D("DROP TABLE IF EXISTS `lonking_enewspublic_update`;");
E_C("CREATE TABLE `lonking_enewspublic_update` (
...
E_D("replace into `lonking_enewspublic_update` values('1','1355124469','1355124476','24','0','|4,2|1,2|2,19|3,1|','','1550303192','1550303192','19','0','0','0');");
