...
<a onclick="window.open('ecmseditor/FileMain.php?type=1&classid=<?=$classid?>&infoid=<?=$id?>&filepass=<?=$filepass?>&sinfo=1&doing=1&field=titlepic<?=$ecms_hashur[ehref]?>','','width=700,height=550,scrollbars=yes');" title="选择已上传的图片"><img src="../data/images/changeimg.gif" border="0" align="absbottom"></a></td></tr><tr><td width='16%' height=25 bgcolor='ffffff'>发布时间</td><td bgcolor='ffffff'><input name="newstime" type="text" value="<?=$r[newstime]?>"><input type=button name=button value="设为当前时间" onclick="document.add.newstime.value='<?=$todaytime?>'"></td></tr><tr><td width='16%' height=25 bgcolor='ffffff'>产品详情</td><td bgcolor='ffffff'>
<?=ECMS_ShowEditorVar("detail",$ecmsfirstpost==1?"":stripSlashes($r[detail]),"Default","","300","100%")?>
</td></tr><tr><td width='16%' height=25 bgcolor='ffffff'>技术选型</td><td bgcolor='ffffff'><?=ECMS_ShowEditorVar("tec",$ecmsfirstpost==1?"":stripSlashes($r[tec]),"Default","","300","100%")?>
</td></tr><tr><td width='16%' height=25 bgcolor='ffffff'>典型应用</td><td bgcolor='ffffff'>
<?=ECMS_ShowEditorVar("typical",$ecmsfirstpost==1?"":stripSlashes($r[typical]),"Default","","300","100%")?>
</td></tr><tr><td width='16%' height=25 bgcolor='ffffff'>售后承诺</td><td bgcolor='ffffff'>
<?=ECMS_ShowEditorVar("saled",$ecmsfirstpost==1?"":stripSlashes($r[saled]),"Default","","300","100%")?>
</td></tr><tr><td width='16%' height=25 bgcolor='ffffff'>知识分享</td><td bgcolor='ffffff'>
<?=ECMS_ShowEditorVar("share",$ecmsfirstpost==1?"":stripSlashes($r[share]),"Default","","300","100%")?>
</td></tr><tr><td width='16%' height=25 bgcolor='ffffff'>资料下载</td><td bgcolor='ffffff'>
<input name="download" type="text" id="download" value="<?=$ecmsfirstpost==1?"":ehtmlspecialchars(stripSlashes($r[download]))?>" size="45">
<a onclick="window.open('ecmseditor/FileMain.php?type=0&classid=<?=$classid?>&infoid=<?=$id?>&filepass=<?=$filepass?>&sinfo=1&doing=1&field=download<?=$ecms_hashur[ehref]?>','','width=700,height=550,scrollbars=yes');" title="选择已上传的文件"><img src="../data/images/changefile.gif" border="0" align="absbottom"></a>
</td></tr></table>