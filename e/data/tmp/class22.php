...
?>
  ...
  <div class="crumb">
    <div class="container">
      <div class="crumb-box">
          <span>您现在的位置：<a href="/">首页</a>&nbsp;>&nbsp;<a href="/xinwenzhongxin/">新闻中心</a>
      </div>
    </div>
  </div>
  <!-- 内容 -->
    ...
    <div class="container">
      <div class="main clear">
        <div class="main-left">
          ...
          <ul class="list-left">
  <li><a href="/xinwenzhongxin/langkunxinwen/">琅琨新闻</a></li>
  <li><a href="/xinwenzhongxin/hangyexinwen/">行业新闻</a></li>
  <li><a href="/xinwenzhongxin/jiejuefangan/">解决方案</a></li>
  <li><a href="/xinwenzhongxin/yinanjieda/">疑难解答</a></li>
</ul>
        </div>
        <div class="main-right">
          <div class="news-list">
            <?php
$bqno=0;
$ecms_bq_sql=sys_ReturnEcmsLoopBq(22,10,0,0,'','newstime DESC');
if($ecms_bq_sql){
while($bqr=$empire->fetch($ecms_bq_sql)){
$bqsr=sys_ReturnEcmsLoopStext($bqr);
$bqno++;
?>
            <div class="news-box">
              <a href="<?=$bqsr['titleurl']?>" class="news-title" target="_blank"><?=$bqr['title']?></a>
              <p class="news-desc"><?=$bqr['intro']?></p>
              <a href="<?=$bqsr['titleurl']?>" class="news-more" target="_blank">&nbsp;>>&nbsp;查看详情</a>
              <span class="news-time"><?=date('Y-m-d',$bqr[newstime])?></span>
            </div>
            <?php
}
}
