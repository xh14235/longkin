...
E_D("DROP TABLE IF EXISTS `lonking_enewsclass_stats_set`;");
E_C("CREATE TABLE `lonking_enewsclass_stats_set` (
...
E_D("replace into `lonking_enewsclass_stats_set` values('1','3600','0','20130717');");
